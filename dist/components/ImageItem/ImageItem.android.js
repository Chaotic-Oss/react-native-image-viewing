...
const ImageItem = ({ imageSrc, onZoom, onRequestClose, onLongPress, delayLongPress, swipeToCloseEnabled = true, doubleTapToZoomEnabled = true, }) => {
    ...
    return (_jsxs(ScrollView, { ref: imageContainer, style: { width: SCREEN_WIDTH, height: SCREEN_HEIGHT }, pagingEnabled: true, nestedScrollEnabled: true, showsHorizontalScrollIndicator: false, showsVerticalScrollIndicator: false, contentContainerStyle: { height: SCREEN_HEIGHT * 2 }, scrollEnabled: swipeToCloseEnabled, ...(swipeToCloseEnabled && {
            onScroll,
            onScrollEndDrag,
